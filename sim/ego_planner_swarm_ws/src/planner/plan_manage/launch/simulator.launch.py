...
def generate_launch_description():
    ...
    plant_odom_topic_arg = DeclareLaunchArgument('plant_odom_topic', default_value=plant_odom_topic, description='Truth/plant odometry topic')
    planner_odom_topic_arg = DeclareLaunchArgument('planner_odom_topic', default_value=planner_odom_topic, description='Planner odometry topic')
    sim_imu_topic_arg = DeclareLaunchArgument('sim_imu_topic', default_value=sim_imu_topic, description='Simulated IMU topic')
    sim_lidar_topic_arg = DeclareLaunchArgument('sim_lidar_topic', default_value=sim_lidar_topic, description='Simulated LiDAR topic')
    sim_depth_topic_arg = DeclareLaunchArgument('sim_depth_topic', default_value=sim_depth_topic, description='Simulated depth topic')
    ...
    so3_quadrotor_simulator = launch_ros.actions.Node(
        ...
        remappings=[('odom', plant_odom_topic),
                    ('imu', sim_imu_topic),
    ...
    ld.add_action(plant_odom_topic_arg)
    ld.add_action(planner_odom_topic_arg)
    ld.add_action(sim_imu_topic_arg)
    ld.add_action(sim_lidar_topic_arg)
    ld.add_action(sim_depth_topic_arg)

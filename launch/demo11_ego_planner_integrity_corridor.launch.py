...
def _launch_setup(context):
    ...
    demo9_args = {
        ...
        "risk_overlay_enable": LaunchConfiguration("risk_overlay_enable"),
        "risk_overlay_use_for_astar": LaunchConfiguration("risk_overlay_use_for_astar"),
        "risk_overlay_use_for_bspline": LaunchConfiguration("risk_overlay_use_for_bspline"),
        "risk_overlay_topic": LaunchConfiguration("risk_overlay_topic"),
        "risk_overlay_lambda_unknown": LaunchConfiguration("risk_overlay_lambda_unknown"),
        "risk_overlay_lambda_stale": LaunchConfiguration("risk_overlay_lambda_stale"),
        "risk_overlay_stale_timeout_s": LaunchConfiguration("risk_overlay_stale_timeout_s"),
        "risk_overlay_stale_tau_s": LaunchConfiguration("risk_overlay_stale_tau_s"),
        "risk_overlay_r_soft": LaunchConfiguration("risk_overlay_r_soft"),
        "risk_overlay_w_soft": LaunchConfiguration("risk_overlay_w_soft"),
        "risk_overlay_w_hard": LaunchConfiguration("risk_overlay_w_hard"),
        "risk_overlay_c_unsafe": LaunchConfiguration("risk_overlay_c_unsafe"),
        "risk_overlay_eps_al_m": LaunchConfiguration("risk_overlay_eps_al_m"),
        "risk_overlay_gamma_h": LaunchConfiguration("risk_overlay_gamma_h"),
        "risk_overlay_gamma_v": LaunchConfiguration("risk_overlay_gamma_v"),
        "risk_overlay_drone_radius_m": LaunchConfiguration("risk_overlay_drone_radius_m"),
        "risk_overlay_safety_buffer_m": LaunchConfiguration("risk_overlay_safety_buffer_m"),
        "risk_overlay_clearance_max_m": LaunchConfiguration("risk_overlay_clearance_max_m"),
        "risk_overlay_clearance_unknown_m": LaunchConfiguration("risk_overlay_clearance_unknown_m"),
        "risk_overlay_edge_sample_alpha": LaunchConfiguration("risk_overlay_edge_sample_alpha"),
        "risk_overlay_bspline_samples_per_segment": LaunchConfiguration("risk_overlay_bspline_samples_per_segment"),
        "risk_overlay_debug_publish": LaunchConfiguration("risk_overlay_debug_publish"),
        "risk_overlay_debug_topic": LaunchConfiguration("risk_overlay_debug_topic"),
        "risk_overlay_debug_publish_hz": LaunchConfiguration("risk_overlay_debug_publish_hz"),
        "risk_overlay_debug_color_mode": LaunchConfiguration("risk_overlay_debug_color_mode"),
        "risk_overlay_debug_cost_max": LaunchConfiguration("risk_overlay_debug_cost_max"),
    ...
    return [
        ...
        Node(
            ...
            parameters=[
                ...
                {"lidar_fim_pca_radius_m": float(LaunchConfiguration("phase2_lidar_fim_pca_radius_m").perform(context))},
                {"lidar_fim_pca_max_points": int(LaunchConfiguration("phase2_lidar_fim_pca_max_points").perform(context))},
                {"lidar_fim_pca_min_support": int(LaunchConfiguration("phase2_lidar_fim_pca_min_support").perform(context))},
                {"lidar_fim_pca_voxel_sample_m": float(LaunchConfiguration("phase2_lidar_fim_pca_voxel_sample_m").perform(context))},
                {"lidar_fim_pca_max_primitives": int(LaunchConfiguration("phase2_lidar_fim_pca_max_primitives").perform(context))},
                {"lidar_fim_use_cloud_normals_first": _as_bool(LaunchConfiguration("phase2_lidar_fim_use_cloud_normals_first").perform(context))},
                ...
                {"local_occupancy_enable_eviction": _as_bool(LaunchConfiguration("phase2_local_occupancy_enable_eviction").perform(context))},
                {"local_occupancy_max_voxels": int(LaunchConfiguration("phase2_local_occupancy_max_voxels").perform(context))},
                {"local_occupancy_radius_m": float(LaunchConfiguration("phase2_local_occupancy_radius_m").perform(context))},
                {"local_occupancy_max_age_s": float(LaunchConfiguration("phase2_local_occupancy_max_age_s").perform(context))},
                {"local_occupancy_eviction_policy": LaunchConfiguration("phase2_local_occupancy_eviction_policy").perform(context)},
                ...
                {"integrity_front_cost_field_frame_id": LaunchConfiguration("phase2_integrity_front_cost_field_frame_id").perform(context)},
                ...
                {"use_unified_risk_grid": _as_bool(LaunchConfiguration("phase2_use_unified_risk_grid").perform(context))},
                {"urg_resolution_m": float(LaunchConfiguration("phase2_urg_resolution_m").perform(context))},
                {"urg_half_extent_x_m": float(LaunchConfiguration("phase2_urg_half_extent_x_m").perform(context))},
                {"urg_half_extent_y_m": float(LaunchConfiguration("phase2_urg_half_extent_y_m").perform(context))},
                {"urg_z_slices": int(LaunchConfiguration("phase2_urg_z_slices").perform(context))},
                {"urg_fresh_timeout_s": float(LaunchConfiguration("phase2_urg_fresh_timeout_s").perform(context))},
                {"urg_stale_timeout_s": float(LaunchConfiguration("phase2_urg_stale_timeout_s").perform(context))},
                {"urg_unknown_penalty": float(LaunchConfiguration("phase2_urg_unknown_penalty").perform(context))},
                {"urg_unknown_tau_s": float(LaunchConfiguration("phase2_urg_unknown_tau_s").perform(context))},
                {"urg_direct_query_on_miss": _as_bool(LaunchConfiguration("phase2_urg_direct_query_on_miss").perform(context))},
                {"urg_export_voxels": _as_bool(LaunchConfiguration("phase2_urg_export_voxels").perform(context))},
                {"urg_compute_gradients": _as_bool(LaunchConfiguration("phase2_urg_compute_gradients").perform(context))},
                {"urg_gradient_mode": LaunchConfiguration("phase2_urg_gradient_mode").perform(context)},
                {"urg_export_voxels_on_update": _as_bool(LaunchConfiguration("phase2_urg_export_voxels_on_update").perform(context))},
                {"urg_export_voxels_on_shutdown": _as_bool(LaunchConfiguration("phase2_urg_export_voxels_on_shutdown").perform(context))},
                {"urg_max_voxels_per_update": int(LaunchConfiguration("phase2_urg_max_voxels_per_update").perform(context))},
                {"urg_rebuild_cancel_check_interval": int(LaunchConfiguration("phase2_urg_rebuild_cancel_check_interval").perform(context))},
                {"urg_keep_legacy_topics": _as_bool(LaunchConfiguration("phase2_urg_keep_legacy_topics").perform(context))},
                {"urg_publish_front_cost_field": _as_bool(LaunchConfiguration("phase2_urg_publish_front_cost_field").perform(context))},
                {"urg_publish_backend_cost_field": _as_bool(LaunchConfiguration("phase2_urg_publish_backend_cost_field").perform(context))},
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("phase2_use_advisory_fim_add", default_value="true"),
        ...
        DeclareLaunchArgument("phase2_lidar_fim_pca_radius_m", default_value="1.5"),
        DeclareLaunchArgument("phase2_lidar_fim_pca_max_points", default_value="2000"),
        DeclareLaunchArgument("phase2_lidar_fim_pca_min_support", default_value="6"),
        DeclareLaunchArgument("phase2_lidar_fim_pca_voxel_sample_m", default_value="0.5"),
        DeclareLaunchArgument("phase2_lidar_fim_pca_max_primitives", default_value="2000"),
        DeclareLaunchArgument("phase2_lidar_fim_use_cloud_normals_first", default_value="true"),
        ...
        DeclareLaunchArgument("phase2_local_occupancy_enable_eviction", default_value="true"),
        DeclareLaunchArgument("phase2_local_occupancy_max_voxels", default_value="200000"),
        DeclareLaunchArgument("phase2_local_occupancy_radius_m", default_value="25.0"),
        DeclareLaunchArgument("phase2_local_occupancy_max_age_s", default_value="5.0"),
        DeclareLaunchArgument("phase2_local_occupancy_eviction_policy", default_value="distance_then_age"),
        ...
        DeclareLaunchArgument("phase2_publish_integrity_cost_grid", default_value="false"),
        ...
        DeclareLaunchArgument("phase2_integrity_front_cost_field_frame_id", default_value="map"),
        ...
        DeclareLaunchArgument("phase2_use_unified_risk_grid", default_value="false"),
        DeclareLaunchArgument("phase2_urg_resolution_m", default_value="1.0"),
        DeclareLaunchArgument("phase2_urg_half_extent_x_m", default_value="25.0"),
        DeclareLaunchArgument("phase2_urg_half_extent_y_m", default_value="25.0"),
        DeclareLaunchArgument("phase2_urg_z_slices", default_value="1"),
        DeclareLaunchArgument("phase2_urg_fresh_timeout_s", default_value="1.0"),
        DeclareLaunchArgument("phase2_urg_stale_timeout_s", default_value="5.0"),
        DeclareLaunchArgument("phase2_urg_unknown_penalty", default_value="3000.0"),
        DeclareLaunchArgument("phase2_urg_unknown_tau_s", default_value="2.0"),
        DeclareLaunchArgument("phase2_urg_direct_query_on_miss", default_value="true"),
        DeclareLaunchArgument("phase2_urg_export_voxels", default_value="false"),
        DeclareLaunchArgument("phase2_urg_compute_gradients", default_value="true"),
        DeclareLaunchArgument("phase2_urg_gradient_mode", default_value="grid_difference"),
        DeclareLaunchArgument("phase2_urg_export_voxels_on_update", default_value="false"),
        DeclareLaunchArgument("phase2_urg_export_voxels_on_shutdown", default_value="false"),
        DeclareLaunchArgument("phase2_urg_max_voxels_per_update", default_value="0"),
        DeclareLaunchArgument("phase2_urg_rebuild_cancel_check_interval", default_value="64"),
        DeclareLaunchArgument("phase2_urg_keep_legacy_topics", default_value="true"),
        DeclareLaunchArgument("phase2_urg_publish_front_cost_field", default_value="true"),
        DeclareLaunchArgument("phase2_urg_publish_backend_cost_field", default_value="true"),

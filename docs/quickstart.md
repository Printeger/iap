...
2. Download [test data](https://zenodo.org/record/7233945).  
    ...
    Alternative links: ROS1 ([downsampled](https://staff.aist.go.jp/k.koide/projects/iap/datasets/os1_128_01_downsampled.bag))  ROS2 ([downsampled](https://staff.aist.go.jp/k.koide/projects/iap/datasets/os1_128_01_downsampled.tar.gz))

3. Confirm that the sensor configuration and ROS topic parameters are set as follows:
```json
iap/config/config.json
...
iap/config/config_sensors.json
  "T_lidar_imu": [-0.006, 0.012, -0.008, 0, 0, 0, 1],
iap/config/config_ros.json
...
```bash
# Load parameters from "iap/config/presets/gpu/config.json"
...
**Example dump data**: [dump_rosbag2_2024_04_16-14_17_01.tar.gz](https://staff.aist.go.jp/k.koide/projects/iap/datasets/dump_rosbag2_2024_04_16-14_17_01.tar.gz) (trajectory errors are injected for manual loop closure test)
...
See [Sensor setup guide](https://github.com/koide3/iap/wiki/Sensor-setup-guide).

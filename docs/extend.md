...
#include <iap/odometry/callback.hpp>
...
* [OdometryEstimationCallbacks](iap/structglim_1_1OdometryEstimationCallbacks.html)
* [SubMappingCallbacks](iap/structglim_1_1SubMappingCallbacks.html)
* [GlobalMappingCallbacks](iap/structglim_1_1GlobalMappingCallbacks.html)
...
The extension module can be loaded into GLIM by adding the name of the created shared library to ```extension_modules``` parameter in ```iap/config/config_ros.json```.

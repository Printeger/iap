...
| IAP-RQ-423 / IAP-RQ-424 | Fresh canonical evidence | Preserve immutable `final_*`; commit/push repair and prove divergence `0 0` before the sole non-overwriting `repair-001_summary.json` / `repair-001_logs` execution | **PENDING PUSHED REPAIR** |

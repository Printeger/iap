...
| IAP-RQ-421 / IAP-RQ-422 / IAP-RQ-423 | Freeze non-overwriting v3 provenance before parser/GPU/live | v3 replacement/overlay/adoption builders and validators bind old evidence, authoritative `static_verification_v3.json`, inventories, modes, aliases, dependency/package resolution and no-bytecode probe; complete hermetic discovery 592/592 with external inventory 17,770 unchanged | **STATIC IMPLEMENTATION READY; RUNTIME COUNTS ZERO** |

...
| IAP-RQ-424 | Regenerable-artifact retirement boundary | Pushed pre-deletion inventory lists 61 literal repository-local build/install roots and `122694791115` expected bytes; raw/compact/live/scientific/log/shared-workspace/PDF exclusions are explicit | **AUTHORIZED / POST-DELETION RECORD PENDING** |

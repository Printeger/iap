...
| IAP-RQ-423 | Prove registered paths equal the production launch surface | Independent AST inspection enumerates all production environment actions and exact five-key/eight-output r3 binding; it fails on the ICRA-052 unconditional literal and any new unregistered action or binding sink | **STRUCTURAL PROOF GREEN** |

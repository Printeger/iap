...
| IAP-RQ-421 / IAP-RQ-422 / IAP-RQ-423 | Byte identity | Review rejected retained `freeze-001` (`51464dff…60582`) for pre-access, undeclared symlink field and incomplete source/runtime coverage; repair expands exact four-field source/install binding and keeps six-package rebuild scope | **13/13 REPAIR GREEN; NEW FREEZE REQUIRED** |

...
See more videos at [Video Gallery](https://github.com/koide3/iap/wiki/Video-Gallery).
...
!!! tip
    Change parameters in `config_ros.json` as follows (see also the [sensor setup guide](https://github.com/koide3/iap/wiki/Sensor-setup-guide)):

...
- Added deterministic mixed-timebase/OOM, temporal-horizon fallback, generation-singleflight, predictor-batch, and accepted-profile fallback regressions. Preflight passed analyzer suites `41/15/111/2`, `test_p1_integrity_cost`, `test_planning_risk_context`, `test_p0_risk_grid_runtime`, `test_p1_replan_admission`, and `test_predictor_module`; fresh authoritative evidence remains pending.
